...
times = [
 datetime.strptime("06 Sep 2021", "%d %b %Y").replace(hour=9, minute=00),
 datetime.strptime("06 Sep 2021", "%d %b %Y").replace(hour=12, minute=00),
 datetime.strptime("06 Sep 2021", "%d %b %Y").replace(hour=15, minute=00),
 datetime.strptime("06 Sep 2021", "%d %b %Y").replace(hour=18, minute=00),
 datetime.strptime("06 Sep 2021", "%d %b %Y").replace(hour=21, minute=00),
]
...
def view_flights(): # Display flights in tabular format
 ...
 table.title = 'Flights'
 for i in range(len(flights)): # Storing the output tuples in
     f = flights[i]
 table.add_row(
 [
 ...
 f.available_business_seats, f.economy_price, f.business_price,
 f.airline
 ]
 )
